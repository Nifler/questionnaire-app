...
class RoleDictionaryQuestionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('questions')->insert([
            ...
            ['id' =>  1, 'title' => 'All Roles — MilTech / Defense',                         'description' => 'У якому напрямку ви працюєте?',         'question_type_id' => 10, 'deleted' => false, 'multi_answers' => false],
            ...
            ['id' =>  5, 'title' => 'Software Engineering (R&D)',                             'description' => 'Уточніть ваш піднапрям:', 'question_type_id' => 12, 'deleted' => false, 'multi_answers' => false],
            ['id' =>  6, 'title' => 'Hardware Engineering & Electronics',                     'description' => 'Уточніть ваш піднапрям:', 'question_type_id' => 12, 'deleted' => false, 'multi_answers' => false],
            ['id' =>  7, 'title' => 'Algorithms / Autonomy / CV / ML',                       'description' => 'Уточніть ваш піднапрям:', 'question_type_id' => 12, 'deleted' => false, 'multi_answers' => false],

            // ── Engineering Domains → напряму ролі, без підсекцій (type 4) ───
            ['id' =>  8, 'title' => 'Embedded & Firmware Engineering',                       'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' =>  9, 'title' => 'Mechanical / CAD / Industrial / Aviation Design',       'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 10, 'title' => 'Robotics / UAV / UGV / Platform Engineering',           'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 11, 'title' => 'Systems Integration / Field Test / Validation',         'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 12, 'title' => 'QA / Test Engineering',                                 'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 13, 'title' => 'Simulation / Modeling / Visualization (R&D)',           'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 14, 'title' => 'DevOps / Infrastructure / Security (R&D)',              'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 15, 'title' => 'Technical Writing / Documentation / Engineering Ops',   'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],

            // ── Non-Engineering Domains → всі мають підсекції (type 3) ───────
            ['id' => 16, 'title' => 'Product & Delivery',        'description' => 'Уточніть ваш піднапрям:', 'question_type_id' => 12, 'deleted' => false, 'multi_answers' => false],
            ['id' => 17, 'title' => 'Production / Operations',   'description' => 'Уточніть ваш піднапрям:', 'question_type_id' => 12, 'deleted' => false, 'multi_answers' => false],
            ['id' => 18, 'title' => 'QA / VTK / Quality Control','description' => 'Уточніть ваш піднапрям:', 'question_type_id' => 12, 'deleted' => false, 'multi_answers' => false],
            ['id' => 19, 'title' => 'Go-to-Market & Corporate',  'description' => 'Уточніть ваш піднапрям:', 'question_type_id' => 12, 'deleted' => false, 'multi_answers' => false],
            ['id' => 20, 'title' => 'People & Operations',       'description' => 'Уточніть ваш піднапрям:', 'question_type_id' => 12, 'deleted' => false, 'multi_answers' => false],

            // ── Engineering SubDomains → ведуть до ролей (type 4) ────────────
            ['id' => 21, 'title' => 'Engineering Management',                  'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 22, 'title' => 'Technical Leadership (Team Level)',        'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ...
            ['id' => 30, 'title' => 'Control & Navigation',                    'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 31, 'title' => 'Computer Vision',                         'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 32, 'title' => 'Machine Learning',                        'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 33, 'title' => 'Embedded AI',                             'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],

            // ── Non-Engineering SubDomains → ведуть до ролей (type 4) ─────────
            ['id' => 34, 'title' => 'Product Management',                          'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 35, 'title' => 'Project / Program Management',               'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 36, 'title' => 'Business / System Analysis',                 'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 37, 'title' => 'Manufacturing / Production Engineering',     'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 38, 'title' => 'Additive Manufacturing / 3D Printing',       'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 39, 'title' => 'Assembly / Technicians / Operators',         'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 40, 'title' => 'Warehouse / Inventory / Logistics',          'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 41, 'title' => 'Operations Management (Production Context)', 'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 42, 'title' => 'Production Quality Control',                 'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 43, 'title' => 'R&D / Product QA',                           'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 44, 'title' => 'Testing & Validation Operations',            'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 45, 'title' => 'Procurement & Supply Chain',                 'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 46, 'title' => 'Sales & Business Development',               'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 47, 'title' => 'Marketing / Communications',                 'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 48, 'title' => 'Grants / Fundraising / Tenders',            'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 49, 'title' => 'Corporate Operations',                       'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 50, 'title' => 'People & Talent',                            'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 51, 'title' => 'Finance & Accounting',                       'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 52, 'title' => 'Legal & Compliance',                         'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 53, 'title' => 'Operations / Administration',                'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
            ['id' => 54, 'title' => 'Training / Instructors',                     'description' => 'Вкажіть вашу роль.', 'question_type_id' => 13, 'deleted' => false, 'multi_answers' => false],
        ]);
        ...
        DB::table('question_answer')->insert([
            ...
            // ── Інше (Custom) — для кожного питання типу Role ────────────────
            ['question_id' =>  8, 'answer_id' => 294],
            ['question_id' =>  9, 'answer_id' => 295],
            ['question_id' => 10, 'answer_id' => 296],
            ['question_id' => 11, 'answer_id' => 297],
            ['question_id' => 12, 'answer_id' => 298],
            ['question_id' => 13, 'answer_id' => 299],
            ['question_id' => 14, 'answer_id' => 300],
            ['question_id' => 15, 'answer_id' => 301],
            ['question_id' => 21, 'answer_id' => 302],
            ['question_id' => 22, 'answer_id' => 303],
            ['question_id' => 23, 'answer_id' => 304],
            ['question_id' => 24, 'answer_id' => 305],
            ['question_id' => 25, 'answer_id' => 306],
            ['question_id' => 26, 'answer_id' => 307],
            ['question_id' => 27, 'answer_id' => 308],
            ['question_id' => 28, 'answer_id' => 309],
            ['question_id' => 29, 'answer_id' => 310],
            ['question_id' => 30, 'answer_id' => 311],
            ['question_id' => 31, 'answer_id' => 312],
            ['question_id' => 32, 'answer_id' => 313],
            ['question_id' => 33, 'answer_id' => 314],
            ['question_id' => 34, 'answer_id' => 315],
            ['question_id' => 35, 'answer_id' => 316],
            ['question_id' => 36, 'answer_id' => 317],
            ['question_id' => 37, 'answer_id' => 318],
            ['question_id' => 38, 'answer_id' => 319],
            ['question_id' => 39, 'answer_id' => 320],
            ['question_id' => 40, 'answer_id' => 321],
            ['question_id' => 41, 'answer_id' => 322],
            ['question_id' => 42, 'answer_id' => 323],
            ['question_id' => 43, 'answer_id' => 324],
            ['question_id' => 44, 'answer_id' => 325],
            ['question_id' => 45, 'answer_id' => 326],
            ['question_id' => 46, 'answer_id' => 327],
            ['question_id' => 47, 'answer_id' => 328],
            ['question_id' => 48, 'answer_id' => 329],
            ['question_id' => 49, 'answer_id' => 330],
            ['question_id' => 50, 'answer_id' => 331],
            ['question_id' => 51, 'answer_id' => 332],
            ['question_id' => 52, 'answer_id' => 333],
            ['question_id' => 53, 'answer_id' => 334],
            ['question_id' => 54, 'answer_id' => 335],
        ]);
    }
}
