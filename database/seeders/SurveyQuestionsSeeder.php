...
class SurveyQuestionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('questions')->insert([
            ['id' => 55, 'title' => 'Рівень позиції',                                                      'description' => null, 'question_type_id' =>  14, 'multi_answers' => 0],
            ...
            ['id' => 63, 'title' => 'Які бенефіти ви маєте зараз',                                        'description' => null, 'question_type_id' =>  22, 'multi_answers' => 1],
            ['id' => 64, 'title' => 'Які бенефіти ви хотіли б мати',                                      'description' => null, 'question_type_id' =>  23, 'multi_answers' => 1],
            ['id' => 65, 'title' => 'Формат роботи зараз',                                                 'description' => null, 'question_type_id' =>  24, 'multi_answers' => 0],
            ['id' => 66, 'title' => 'Бажаний формат роботи',                                               'description' => null, 'question_type_id' =>  25, 'multi_answers' => 0],
            ['id' => 67, 'title' => 'Тип компанії, в якій ви працюєте зараз',                              'description' => null, 'question_type_id' =>  26, 'multi_answers' => 0],
            ['id' => 68, 'title' => 'Розмір компанії',                                                     'description' => null, 'question_type_id' =>  27, 'multi_answers' => 0],
            ['id' => 69, 'title' => 'Тип компанії, який є для вас пріоритетним при зміні роботи',          'description' => null, 'question_type_id' =>  28, 'multi_answers' => 0],
            ['id' => 70, 'title' => 'Поточна локація проживання',                                          'description' => null, 'question_type_id' =>  29, 'multi_answers' => 0],
            ['id' => 71, 'title' => 'Чи розглядаєте зміну роботи найближчим часом',                        'description' => null, 'question_type_id' =>  30, 'multi_answers' => 0],
            ['id' => 72, 'title' => 'Фактори при зміні роботи',                                            'description' => null, 'question_type_id' =>  31, 'multi_answers' => 1],
        ]);
