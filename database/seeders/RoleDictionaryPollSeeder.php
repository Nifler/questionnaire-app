...
class RoleDictionaryPollSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('polls')->insert([
            ['id' => 1, 'title' => 'MilTech / Defense Salary & Market Review', 'description' => "Важливо:\n- опитування є повністю анонімним\n- жодні особисті дані не збираються\n- усі результати будуть використовуватися лише у зведеному вигляді для аналітики.\n\nМета опитування — зібрати дані для MilTech / Defense Salary & Market Report, який відображатиме реальний стан ринку: компенсації, бенефіти, умови роботи та фактори вибору роботодавця. Всі відповіді анонімні та використовуються лише в агрегованому вигляді."],
        ]);
